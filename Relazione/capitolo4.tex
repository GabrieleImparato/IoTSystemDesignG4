...
La successiva fase di design dell'architettura dovrà pertanto adottare un approccio integrato e trasversale, valutando le interdipendenze tra i vincoli e definendo compromessi espliciti e motivati per ciascun punto critico.