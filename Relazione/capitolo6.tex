...
\noindent L'utilizzo dell'AI non ha sostituito il contributo intellettuale del gruppo, ma ha rappresentato un supporto metodologico nelle seguenti attività.
...
\noindent Questo confronto ha permesso al gruppo di maturare una scelta consapevole del dominio ritenuto soggettivamente più interessante, non in termini di semplicità, ma di ricchezza di trade-off progettuali.

\noindent La decisione finale è stata presa autonomamente dal gruppo, sulla base di considerazioni critiche.
...
\noindent I contenuti tecnici, le analisi dei requisiti e le valutazioni ingegneristiche restano frutto esclusivo dell'elaborazione del gruppo.
...
\noindent Lo strumento è stato utilizzato come supporto esplorativo con lo scopo di:
\begin{itemize}
...
\noindent La selezione finale del caso di studio è stata effettuata dal gruppo, sulla base della coerenza con i requisiti progettuali identificati nel Capitolo 2.
